...
int NF_Status;  //NF_DROP = 0, NF_ACCEPT = 1;
char* block_site;

void find_block_site(unsigned char* data) {
    //    int i;
    //    for (i = 0; i < size; i++) {
    //        if (i % 16 == 0)
    //            printf("\n");
              ...
              struct nfq_data *nfa, void *data)
{
    ...
    return nfq_set_verdict(qh, id, NF_Status, 0, NULL);     //NF_DROP = 0, NF_ACCEPT = 1;
}
